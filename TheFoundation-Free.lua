...
local Window = Library:CreateWindow({
	...
	Title = "Vortex Hub丨Free",
	Footer = "[Game]:The Foundation(Game) [QQ]:1037164658",
	Icon = no,
	NotifySide = "Right",
...
local RightGroupBox = Tabs.Main:AddRightGroupbox("<b>快速按钮</b>")
...
local NotifyEntities = {"Rush", "Screech", "Ram", "Ambush", "Hordebats", "Eyes", "Stare", "Onslaught"}
...
if Object.Name == 'Hoardbat' and NotifyEntitiesInternal["Hoardbat"] then
        Library:Notify('Hoardbat已生成!')
    end
end)
...
MenuGroup:AddLabel("菜单键位")
	:AddKeyPicker("MenuKeybind", { Default = "RightShift", NoUI = false, Text = "菜单键位" })
